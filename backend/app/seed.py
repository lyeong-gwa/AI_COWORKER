...
async def seed_database():
    ...
    async with async_session_maker() as session:
        ...
        # ========================================
        # 2. Knowledge Documents (3개 - MD 파일로 생성)
        # ========================================
...
모든 서버 정보를 빠짐없이 포함하세요. 실제 데이터로 각 셀을 채우세요.""",
        ...
        api_definitions = [
            ApiDefinition(
                ...
                method="GET",
                url_template="http://localhost:7000/rest-comm/support/view-list",
        ...
        wf_nodes = [
            WorkflowNode(
                ...
                config={
                    ...
                    "method": "GET",
                    "url": "http://localhost:7000/rest-comm/support/view-list",
                    "inputFields": [],
                    "defaultParams": {},
                },
                input_mapping={},
        ...
        wf2_nodes = [
            WorkflowNode(
                ...
                node_id="trigger",
                definition_type=NodeDefType.FORM.value,
                ai_node_id=None,
                name="입력 폼",
                position={"x": 50, "y": 250},
                config={
